...
The default CAPTCHA is a simple text-based test. There is also the option to use [reCAPTCHA](http://recaptcha.net) if you want something more robust (note: this requires getting a free API key).
...
1. A sample of the CAPTCHA that will be displayed to potential spammers when using *reCAPTCHA*.

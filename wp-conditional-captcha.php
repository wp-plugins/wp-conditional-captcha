	...
	private function recaptcha_check () {
		if( $this->options['recaptcha_use_new_api'] ) {
			...
			if ( empty( $_POST['recaptcha_challenge_field'] ) || empty( $_POST['recaptcha_response_field'] ) ) {
				return 'incorrect-captcha-sol';		// discard spam submissions upfront
			}

			$response = $this->recaptcha_post( array( 'privatekey' => $this->options['recaptcha-private-key'], 'remoteip' => $_SERVER['REMOTE_ADDR'], 'challenge' => $_POST['recaptcha_challenge_field'], 'response' => $_POST['recaptcha_response_field'] ) );
